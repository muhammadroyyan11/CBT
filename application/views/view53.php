					...
					<div class="wrapper">	
						<div class="container">
							<div class="row plr15" >
								...
								<form class="form-horizontal" action="<?php echo site_url('simpaneditpeminatan');?>" method="POST">
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-4">ID Peminatan</label>
											<div class="col-md-8">
												<?php echo $peminatan->id_peminatan;?>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input class="form-control input-sm" type="text" name="nama_peminatan" value="<?php echo $peminatan->nama_peminatan;?>" required>
												</div>
											</div>
										</div>
										<div class="form-group">  
											...
											<div class="col-md-8">  
												<input type="hidden" name="id_peminatan" value="<?php echo $peminatan->id_peminatan;?>" />
