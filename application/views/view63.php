					...
					<div class="wrapper">	
						...
						<div class="container">
							<div class="row plr15" >
								...
								<form class="form-horizontal" action="<?php echo site_url('simpanproduk');?>" enctype="multipart/form-data" method="POST">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="nama_produk" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<textarea class="form-control input-sm" type="text" name="deskripsi" required></textarea>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input class="form-control input-sm" type="text" name="harga" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-4">Foto Produk <br/>(maks 135 x 180px)</label>
											<div class="col-md-8">
												<div class="input-group">
