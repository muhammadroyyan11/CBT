				...
				<div class="row" >
					...
					<div class="col-md-10" >
						<div class="panel panel-default col-md-8">
							...
							<textarea id="contents" class="ckeditor" name="editor1" style="width: 100%;height:300px;"><?php echo preg_replace('/(<p.+?)style=".+?"(>.+?)/i', "$1$2",str_replace("\ ","\\",strip_tags($contents,"<img><table><tr><td><th><tbody><b><i><br><p><sub><sup><ins><small><del><mark><em><strong><form><input><textarea><label><caption><ul><ol><li>"))); ?></textarea>
							...
							<p>
							<input type="submit" value="Source" name="submitsave" formaction="../tls/view85.php" class="btn btn-primary btn-sm mr15">
							<?php /* <a href="https://word2cleanhtml.com/" target="_blank" class="btn btn-warning btn-sm">Clean HTML</a> */ ?>
							</p><br/><br/>
									<p><input class="form-control" type="text" name="alm" id="alm" placeholder="Input Alamat Gambar" style="width:100%;"disabled />
									</p>
									<p style="margin-top:10px;">
									<input class="form-control" type="text" name="prf" id="prf" placeholder="Input Prefiks Gambar" style="width:100%;" disabled />
									</p>
									
									
								
							
							<button type="button" onclick="removeSpaces()" class="btn btn-success btn-sm" style="margin-top:10px;" disabled>Proses</button>
