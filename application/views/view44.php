					...
					<div class="wrapper">	
						...
						<div class="container">
							<div class="row plr15" >
								...
								<form class="form-horizontal" action="<?php echo site_url('simpanjurusan');?>" method="POST">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="kode_jurusan" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="pil_jurusan" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="snl" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="nama_univ" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="ps" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">  
