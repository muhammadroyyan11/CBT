					...
					<div class="wrapper">	
						<div class="container">
							<div class="row plr15" >
								...
								<form class="form-horizontal" action="<?php echo site_url('simpaneditfolder');?>" method="POST">
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-4">ID Kategori</label>
											<div class="col-md-8">
												<?php echo $folder->id_folder;?>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input class="form-control input-sm" type="text" name="nama_folder" value="<?php echo $folder->nama_folder;?>" required>
												</div>
											</div>
										</div>
										<div class="form-group">  
											...
											<div class="col-md-8">  
												<input type="hidden" name="id_folder" value="<?php echo $folder->id_folder;?>" />
												<input class="btn btn-success btn-sm mr15" type="submit" value="Simpan" /><a class="btn btn-danger btn-sm" href="<?php echo site_url('folder');?>">Back </a>
												</div>
										</div>
									</div>
									<div class="col-md-6">
