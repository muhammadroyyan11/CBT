					...
					<div class="wrapper">	
						...
						<div id="container1">
							<div id="body">	
								...
								<div class="container">
									<div class="row whitebox" >
										<div class="col-md-3 pb10">
											<a class="btn btn-success btn-sm" href="<?php echo site_url('tambahjurusan');?>">TAMBAH JURUSAN</a> <a class="btn btn-success btn-sm" target="_blank" href="<?php echo base_url('tls/view83.php');?>">UPLOAD JURUSAN</a>
										</div>
										<div class="col-md-6">
											<form action="<?php echo site_url('carijurusan');?>" method="POST"> 
								...
								<div class="clear"></div>			
								<div class="pb10"></div>					
								<form action="<?php echo site_url('aktivasijurusan');?>" method="POST" id="frm1"> 
									<div class="container">
											...
											<div class="col-md-12" >
												...
												<table width="100%" class="table-new tabelradius2" border="0" cellspacing="0" cellpadding="5">
													<tr class="tr-head">
														...
														<td width="10%" align="center" class="line2">Kode Jurusan</td>
														<td width="42%" align="center" class="line2">Pilihan Jurusan</td>
														<td width="7%" align="center" class="line2">SNL</td>
													    <td width="25%" align="center" class="line2">Universitas</td>
													...
													<?php 
														...
														foreach ($View_jurusan as $jurusan) {?>
														<tr>
															<td class="line" valign="top" style="padding-left:3px;padding-top:6px;">		
																<input type="checkbox" name="id[]" value="<?php echo $jurusan->id ?>">
															</form>
														</td>	
														<td align="center" class="line">
															<?php echo $i; ?>
														</td>
														<td align="center" class="line" style="background:#FFFFCB;"> <?php echo $jurusan->kode_jurusan; ?> </td>
														<td align="center" class="line"> <?php echo $jurusan->pil_jurusan; ?> </td>
														<td align="center" class="line"> <?php echo $jurusan->standar_nilai; ?> </td>
														<td align="center" class="line"> <?php echo $jurusan->nama_univ; ?> </td>
														<td align="center" class="line3"> 
															<a href="<?php echo site_url('editjurusan/'.$jurusan->id);?>" title="edit"><image src="<?php echo base_url(); ?>assets/css/images/useredit.png"></a>&nbsp;&nbsp;
																<a href="#" title="hapus" onclick="alertify.confirm('Anda yakin ingin menghapusnya?<br/>',function(e){if(e) {window.location.href ='<?php echo site_url('hapusjurusan/'.$jurusan->id);?>';  alertify.success('Proses dijalankan.');} else {alertify.error('Proses dibatalkan.');}});"><image src="<?php echo base_url(); ?>assets/css/images/cross.png"></a>
																</td>
															</tr>															
														<?php $i++;} ?>
													</table>
