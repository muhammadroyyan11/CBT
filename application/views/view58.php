					...
					<div class="wrapper">	
						...
						<div class="container">
							<div class="row plr15" >
								...
								<form class="form-horizontal" action="<?php echo site_url('simpanfolder');?>" method="POST">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" name="nama_folder" class="form-control input-sm" required>
												</div>
											</div>
										</div>
										<div class="form-group">  
