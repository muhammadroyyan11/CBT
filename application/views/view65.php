							...
							<div id="body">	
								...
								<div class="container">
									<div class="row whitebox" >
										...
										<div class="col-md-6">
											<form action="<?php echo site_url('caripembelian');?>" method="POST"> 
								...
								<div class="clear"></div>			
								<div class="pb10"></div>					
								<form action="<?php echo site_url('aktivasipembelian');?>" method="POST" id="frm1"> 
									<div class="container">
											...
											<div class="col-md-5">
												...
												<div class="col-md-3 pt5b10" style="color:#fff;">
													<?php	
														...
														$alamat_semua = site_url('pembelian');
											...
											<div class="col-md-12" >
												...
												<table width="100%" class="table-new tabelradius2" border="0" cellspacing="0" cellpadding="5">
													<tr class="tr-head">
														...
														<td width="7%" align="center" class="line2">Order ID</td>
														<td width="6%" align="center" class="line2">Tanggal</td>
														<td width="20%" align="center" class="line2">Siswa</td>
														<td width="7%" align="center" class="line2">Kelas</td>
														<td width="7%" align="center" class="line2">Hp</td>
														<td width="10%" align="center" class="line2">Produk</td>
														<td width="5%" align="center" class="line2">Harga</td>
														<td width="5%" align="center" class="line2">Total</td>
														
														<td width="12%" align="center" class="line2">Tipe Pembayaran</td>
													...
													<?php 
														...
														foreach ($View_pembelian as $pembelian) {?>
														<tr>
															<td class="line" valign="top" style="padding-left:3px;padding-top:6px;">	
																
																<input type="checkbox" name="id_pembelian[]" value="<?php echo $pembelian->morderid ?>">
														...
														<td align="center" class="line">
														 ...
														 <td align="center" class="line"><?php echo $pembelian->morderid; ?></td>
														<td align="center" class="line"> <?php echo date('d-m-y',strtotime($pembelian->date)); ?></td>
														<td align="center" class="line"> <?php echo $pembelian->nama; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->nama_kelas; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->hp_siswa; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->name; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->price; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->gross_amount; ?> </td>
														<td align="center" class="line"> <?php echo $pembelian->payment_type; ?> </td>
													
														<td align="center" class="line">
                                                            <?php if ($pembelian->status_code == "PAID") {
                                                            ?>
                                                            <span class="badge bg-success" style="font-size:10px;background:#4cae4c;">Success</span>
                                                            <?php } else { ?>
														...
														<td>
															...
															<a href="#" title="hapus" onclick="alertify.confirm('Anda yakin ingin menghapusnya?<br/>',function(e){if(e) {window.location.href ='<?php echo site_url('hapuspembelian/'.$pembelian->morderid);?>';  alertify.success('Proses dijalankan.');} else {alertify.error('Proses dibatalkan.');}});"><image src="<?php echo base_url(); ?>assets/css/images/cross.png"></a>
